...
This project is released under the MIT License. The MIT License covers copyright
permission for the source code. It does not grant permission to use project
...
not imply endorsement, official status, or compatibility unless that is true.

## Permitted Uses

You may use the marks to:
...
Please get written permission before you:

- Use the marks as the name of a fork, modified distribution, hosted service, or
  commercial product.
- Publish a package, binary, plugin, or installer whose name could be confused
  with the official project.
- Use a project logo in marketing, merchandise, sponsorship material, or paid
  services.
- Register or use a domain name, social handle, app name, marketplace listing, or
  company name that contains the marks.

## Forks And Modified Versions

You may fork and modify the code under the MIT License. If you distribute a
...
This policy is not legal advice. Trademark rights and registration status can
change by jurisdiction. If you need a commercial license or written permission,
