...
def managed_claude_block(summary_text):
    ...
    return "\n".join(
        [
            MANAGED_START,
            "# OpenRelix Active Personal Memory",
            "",
            "This block is generated by OpenRelix from global memory plus the bounded active-project slice when a project is selected.",
