...
def managed_codex_block(summary_text):
    ...
    return "\n".join(
        [
            ...
            "",
            "This block is generated by OpenRelix as supplemental context for Codex.",
            "Codex-owned memory outside this block must be preserved.",
...
def managed_claude_block(summary_text):
    ...
    return "\n".join(
        [
            ...
            "# OpenRelix Personal Memory",
            "",
            "This block is generated by OpenRelix from global and project memory within their bounded host-context budgets.",
            "Edit OpenRelix memory sources instead of editing this managed block by hand.",
            "",
            body,
            MANAGED_END,
