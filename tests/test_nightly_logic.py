...
""",
    ...
    def test_build_html_reformats_token_units_on_language_switch(self):
        ...
        self.assertIn("if (requestSeq !== state.tokenRequestSeq) {", html)
    ...
    def test_macos_client_under_page_background_tracks_web_theme(self):
        ...
        self.assertIn("ensureTokenLiveLaunchAgent(forceRestart: false)", mac_client)
        self.assertIn("ensureTokenLiveLaunchAgent(forceRestart: true)", mac_client)
